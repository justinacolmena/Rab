...
We do not like the results of this multiple regression. As we do this analysis shortly after the end of the first quarter 2018, the company's stock price shows an extremely high positive correlation with the price of gold, and a strong negative correlation with the price of silver. Such correlations sometimes expose a publicly traded mining company's hedge position in futures markets. This company may have hedged against more silver than the market believes it has in reserve, and on the other hand be inadequatedly hedged against a fall in the price of gold.  Further analysis is warranted.
